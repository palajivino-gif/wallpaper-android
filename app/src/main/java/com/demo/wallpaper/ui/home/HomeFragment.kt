...
import com.demo.wallpaper.ads.AdsConfig
import com.demo.wallpaper.ads.BannerAdController
import com.demo.wallpaper.ads.InterstitialAdController
import com.demo.wallpaper.data.WallpaperRepository
import com.demo.wallpaper.databinding.FragmentHomeBinding
import com.demo.wallpaper.model.Categories
    ...
    private fun setupChips() {
        ...
        Categories.ALL_ORDERED.forEach { category ->
            val chip = Chip(requireContext()).apply {
                ...
                setChipBackgroundColorResource(com.demo.wallpaper.R.color.chip_bg_color)
                setTextColor(resources.getColorStateList(com.demo.wallpaper.R.color.chip_text_color, null))
                chipStrokeWidth = 0f
